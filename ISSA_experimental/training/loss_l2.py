...
class StyleGAN2Loss(Loss):
    def __init__(self, device, G_mapping, G_synthesis, D, augment_pipe=None, E=None, style_mixing_prob=0.9, r1_gamma=10, pl_batch_shrink=2, pl_decay=0.01, pl_weight=2, recon_weight=1.0):
        super().__init__()
        self.device = device
        ...
        if do_Gmain:
            with torch.autograd.profiler.record_function('Gmain_forward'):
                if self.encode:
                    ...
                    l2_loss = self.l2_weight * self.l2(gen_img, real_img)
                    training_stats.report('Loss/reconstruction', l2_loss)
